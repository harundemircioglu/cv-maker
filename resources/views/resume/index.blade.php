...
@section('content')
    ...
    <div class="flex w-full">
        <div class="w-full">
            ...
            <div class="flex flex-col mb-5">
                <div>
                    <form action="{{ route('resume.workExperience.store', ['resumeId' => $resume->id]) }}" method="POST">
                        @csrf
                        <button>Store</button>
                    </form>
                </div>
        ...
        <div class="w-full">
            <div class="flex flex-col mb-5">
                <div>
                    <form action="{{ route('resume.project.store', ['resumeId' => $resume->id]) }}" method="POST">
                        @csrf
                        <button>Store</button>
                    </form>
                </div>
            ...
            <div class="flex flex-col mb-5">
                <div>
                    <form action="{{ route('resume.language.store', ['resumeId' => $resume->id]) }}" method="POST">
                        @csrf
                        <button>Store</button>
                    </form>
                </div>
            ...
            <div class="flex flex-col mb-5">
                <div>
                    <form action="{{ route('resume.certificate.store', ['resumeId' => $resume->id]) }}" method="POST">
                        @csrf
                        <button>Store</button>
                    </form>
                </div>
