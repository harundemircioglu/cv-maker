...
Route::prefix('resume')->name('resume.')->middleware(['auth'])->group(function () {
    ...
    Route::prefix('certificate')->name('certificate.')->group(function () {
        Route::post('/store', [CertificateController::class, 'store'])->middleware('check.usage:certificates')->name('store');
    ...
    Route::prefix('education')->name('education.')->group(function () {
        Route::post('/store', [EducationController::class, 'store'])->middleware('check.usage:educations')->name('store');
    ...
    Route::prefix('language')->name('language.')->group(function () {
        Route::post('/store', [LanguageController::class, 'store'])->middleware('check.usage:languages')->name('store');
    ...
    Route::prefix('project')->name('project.')->group(function () {
        Route::post('/store', [ProjectController::class, 'store'])->middleware('check.usage:projects')->name('store');
    ...
    Route::prefix('work-experience')->name('workExperience.')->group(function () {
        Route::post('/store', [WorkExperienceController::class, 'store'])->middleware('check.usage:work_experiences')->name('store');
